...
class PetFriends:
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
        ...
        res = requests.get(self.base_url + 'api/pets', headers=headers, params=filter_param)
        status = res.status_code
        result = ""
        try:
            result = res.json()
    ...
    def creat_pet_simpel(self, auth_key: json, name: str, animal_type: str, age: int) -> json:
